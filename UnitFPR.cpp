...
//*MOSTRAR*
// PROGRAMA QUE MUESTRA LOS PRIMEROS N NÚMEROS ENTEROS //
...
//---------------------------------------------------------------------------
// PROGRAMA QUE MUESTRA LOS PRIMEROS N NÚMEROS IMPARES //
void __fastcall TFrmFPRecursivo::PNumerosImparesFPRecursivoClick(TObject *Sender)
{
	 Mostrar_digitos_impares(StrToInt(EdtFPRecursivo1->Text));
}
//---------------------------------------------------------------------------
